...
weigths_path = '/home/users/u12559743/Documentos/complexity_antiga/Complexity/results/min_loss.pth'
...
with mlflow.start_run(run_name='loss model') as run:
    epochs = 10
    ...
    for e in range(epochs):
        ...
        mlflow.log_metric('acurácia treino min loss',f'{train_acc:2f}', step=e)
        acc_values_train.append(train_acc)
        loss_values_train.append(train_loss / len(train_loader))
        mlflow.log_metric('perda treino min loss',train_loss, step=e)
        ...
        mlflow.log_metric('complexidade min loss',complexidade, step=e)
        mlflow.log_metric('disequilibrio min loss',disequilibrio, step=e)
        mlflow.log_metric('entropia min loss', entropia, step=e)
        ...
        mlflow.log_metric('acuracia validacao min loss', val_acc, step=e)
        loss_values_val.append(valid_loss / len(val_loader))
        mlflow.log_metric('perda validacao min loss', valid_loss, step=e)
