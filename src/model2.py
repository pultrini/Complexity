...
pretrained_dict = torch.load('/home/users/u12559743/DAVI/IC/Complexity/results/min_loss.pth')
model = ResNet()
...
for e in range(epochs):
    ...
    if valid_loss  < min_valid_loss:
        ...
        torch.save(model.state_dict(), 'min_loss_model2.pth')
    if complexidade  > max_valid_complex:
        max_valid_complex = complexidade 
        torch.save(model.state_dict(), 'max_complexity_model2.pth')
